...
class Course(models.Model):
    ...
    thumbnail=models.ImageField(upload_to='courses/',default='default/course.png',blank=True, null=True)
...
class CourseVideo(models.Model):
    ...
    thumbnail=models.ImageField(upload_to=video_path,default='default/course.png',blank=True, null=True)
